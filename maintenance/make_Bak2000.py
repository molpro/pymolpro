...
reactions_db.dump(
    os.path.realpath(os.path.join(__file__, '..', '..', 'pymolpro', 'share', 'database', 'Bak2000_reactions' + '.json')))
...
atomisations_db.dump(
    os.path.realpath(os.path.join(__file__, '..', '..', 'pymolpro', 'share', 'database', 'Bak2000_atomisations' + '.json')))
